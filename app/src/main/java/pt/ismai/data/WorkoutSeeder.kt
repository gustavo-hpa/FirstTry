    ...
    fun getPredefinedWorkouts(): List<Treino> {
        ...
        return listOf(
            ...
            Treino(
                ...
                duracao = 30.minutes,
                exercicios = allEx.filter { it.id in 101..107 || it.id in 211..214 },
                dataCriacao = Date()
            ),
            ...
            Treino(
                ...
                duracao = 45.minutes,
                exercicios = allEx.filter { it.id in 277..282 || it.id in 293..298 || it.id == 305 },
                dataCriacao = Date()
            ),
            ...
            Treino(
                ...
                duracao = 60.minutes,
                exercicios = allEx.filter { it.id in listOf(238, 243, 264, 268, 274, 290) },
                dataCriacao = Date()
            ),
            ...
            Treino(
                ...
                nivelDificuldade = NivelDificuldade.DIFICIO,
                duracao = 40.minutes,
                exercicios = allEx.filter { it.id in 155..161 || it.id in 204..210 },
                dataCriacao = Date()
            ),
        ...
        // 5. Explosão e Finalização para Bases (NOVO)
            Treino(
                ...
                nivelDificuldade = NivelDificuldade.MEDIA,
                duracao = 35.minutes,
                exercicios = allEx.filter { it.id in 293..314 || it.id in 213..214 },
                dataCriacao = Date()
            )
        )
    }
